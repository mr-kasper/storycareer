  ...
  return (
    <div className="py-32 h-full">
      <div className="flex flex-col space-y-3">
        <h1 className="text-3xl max-w-2xl md:text-5xl font-bold">Explore Career Stories</h1>
        <p className="text-muted-foreground max-w-lg">
          Welcome to the heart of StoryCareer, where real stories from professionals across various
          fields come alive. Dive into these narratives to find inspiration, learn from others
          experiences, and see the diverse paths people have taken in their careers.
        </p>
      </div>
